...
import CreateProfForm from "@/components/admin/CreateProfForm";
interface Prof {
  nome: string;
  email: string;
  id: number;
  ...
  return (
    <>
      ...
      <main className="min-h-screen flex-wrap bg-gray-150  flex items-start justify-between">
        <div className="w-1/5 h-screen bg-gray-50 shadow "></div>
        <div className="w-4/5 mt-10  gap-10 flex items-center flex-col justify-center">
                ...
                {professor.map((item: Prof, index) => (
                  ...
                  >
                    ...
                    <div className="w-full h-1/3 gap-10 flex items-center justify-center">
                      ...
                      <div className="w-12 h-12 flex items-center justify-center rounded-md hover:bg-yellow-500 cursor-pointer bg-yellow-400">
                        <Pencil
                          strokeWidth={2}
                          size={35}
