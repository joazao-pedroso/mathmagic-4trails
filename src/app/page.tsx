...
export default function Trilha() {
  ...
  return (
    <>
      <Header home={true} />
      <main className="min-h-screen flex-wrap p-20 bg-gray-150 gap-10 flex items-center justify-center">
        <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 flex flex-col items-center gap-6">
          ...
          <ul className="flex flex-col gap-5 w-full">
            {steps.map((step, index) => (
              <li
                key={index}
                onClick={() => router.push(`trails/one${step.path}`)}
        ...
        <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 flex flex-col items-center gap-6">
          ...
          <ul className="flex flex-col gap-5 w-full">
            {steps.map((step, index) => (
              <li
                key={index}
                onClick={() => router.push(`trails/two${step.path}`)}
                className="flex items-center gap-4 bg-[#F2FCFC] border-2 border-[#227C9D] hover:bg-[#D3F4F2] text-[#227C9D] rounded-xl p-4 cursor-pointer transition-all"
              >
                <div className="w-10 h-10 rounded-full bg-[#227C9D] flex items-center justify-center">
                  <CheckCircle className="text-white" size={22} />
        ...
        <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 flex flex-col items-center gap-6">
          ...
          <ul className="flex flex-col gap-5 w-full">
            {steps.map((step, index) => (
              <li
                key={index}
                onClick={() => router.push(`trails/three${step.path}`)}
                className="flex items-center gap-4 bg-[#F2FCFC] border-2 border-[#227C9D] hover:bg-[#D3F4F2] text-[#227C9D] rounded-xl p-4 cursor-pointer transition-all"
              >
                <div className="w-10 h-10 rounded-full bg-[#227C9D] flex items-center justify-center">
                  <CheckCircle className="text-white" size={22} />
        ...
        <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 flex flex-col items-center gap-6">
          ...
          <ul className="flex flex-col gap-5 w-full">
            {steps.map((step, index) => (
              <li
                key={index}
                onClick={() => router.push(`trails/four${step.path}`)}
                className="flex items-center gap-4 bg-[#F2FCFC] border-2 border-[#227C9D] hover:bg-[#D3F4F2] text-[#227C9D] rounded-xl p-4 cursor-pointer transition-all"
              >
                <div className="w-10 h-10 rounded-full bg-[#227C9D] flex items-center justify-center">
                  <CheckCircle className="text-white" size={22} />
